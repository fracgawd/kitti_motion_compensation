...
void StackAndProcessProjectionImagePair(cv::Mat const &img_top, cv::Mat const &img_bottom, Path const output_file) {
  ...
  cv::putText(stacked, "Raw", cv::Point(10, 30), cv::FONT_HERSHEY_DUPLEX, 1.0, CV_RGB(255, 255, 255), 2);
  cv::putText(stacked, "Motion Compensated", cv::Point(10, image_height + 30), cv::FONT_HERSHEY_DUPLEX, 1.0,
